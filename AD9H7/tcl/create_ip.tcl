...
CONFIG.PF0_SUBSYSTEM_VENDOR_ID {0666} \
CONFIG.PF1_SUBSYSTEM_VENDOR_ID {0666} \
CONFIG.PF2_SUBSYSTEM_VENDOR_ID {0666} \
CONFIG.PF3_SUBSYSTEM_VENDOR_ID {0666} \
...
#                     CONFIG.PF0_SUBSYSTEM_ID {0666}                     \
#                     CONFIG.enable_gen4 {false}                         \
#                     CONFIG.PL_LINK_CAP_MAX_LINK_SPEED {8.0_GT/s}       \
#                     CONFIG.PL_LINK_CAP_MAX_LINK_WIDTH {X16}            \
#                     CONFIG.pcie_blk_locn {X1Y0}                        \
#                     CONFIG.SRIOV_FIRST_VF_OFFSET {0}                   \
#                     CONFIG.PF0_SRIOV_FIRST_VF_OFFSET {0}               \
